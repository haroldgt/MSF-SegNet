...
from dataset import Adata_loader
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='config/parameters.yaml') # config/parameters.yaml
    ...
    """
    train_dataset_loader, val_dataset_loader = Adata_loader.build(dataset_config=dataset_config,
    ...
    if os.path.exists(model_load_path):
        my_model = load_pretrain_model(model_load_path, my_model)
    # 2. model to gpu
